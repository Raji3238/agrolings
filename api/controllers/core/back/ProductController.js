...
module.exports = {
    ...
    edit: function (req, res, id) {
        ...
        console.info('modification product id: ', req.params);
        ...
        if (req.params.id && (req.params.id.length > 0 )) {
            ...
            Product.find(queryOptions, function (err, products) {
                ...
                CoreReadDbService.getCategoryList().then(function(categoryList){
                    ...
                    return res.view(pathTemplateBackCore + 'commun-back/main.ejs', result);
                    // var product_name = req.params.name? req.params.name:products[0].name;
                    // var product_price = req.params.price?req.params.price:products[0].price;
                    // var product_stock = req.params.stock?req.params.stock:products[0].stock;
                    // var product_description = req.params.description?req.params.description:products[0].description; 
                    // console.log('product_name',product_name,'/n','product_price',product_price,'/n','product_stock',product_stock,'/n','product_description',product_description)
                    // Product.update({id:productId},{$set:{name:product_name,price:product_price,stock:product_stock,description:product_description}},function(err,savedProduct){
                    //     console.log('saved',savedProduct,'err',err)
                    //     return res.view(pathTemplateBackCore + 'commun-back/main.ejs', result);
                    // })
