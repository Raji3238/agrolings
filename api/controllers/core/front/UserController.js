...
module.exports = {
    profile: function (req, res) {
        ...
        async.waterfall([
            ...
            function GetUserAndOrders(next) {
                ...
                console.info('user iddd ', req.session.user.id,'queryOptions',queryOptions);
    ...
    signup: function (req, res) {
        ...
        var data = {};
        console.log('inside usercontroller signup',req.body.name,'email',req.body.email,'password',req.body)
            ...
            function Validate(user, next) {
                ...
                try {
                    ...
                    if (user && user.password) {
                        console.log('validate user login',req.body.password,'db pass',user.password)
